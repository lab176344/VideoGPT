...
class VideoGPT(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--vqvae', type=str, default='lightning_logs/version_17/checkpoints/epoch=410-step=43976.ckpt',
                            help='path to vqvae ckpt, or model name to download pretrained')
        parser.add_argument('--n_cond_frames', type=int, default=0)
        parser.add_argument('--class_cond', action='store_false')
        ...
        parser.add_argument('--attn_type', type=str, default='full',
                            choices=['full', 'sparse'])
        parser.add_argument('--attn_dropout', type=float, default=0.3) #'/home/lambda-save/lakshman_experiments_don\'t_delete/VideoGPT/lightning_logs/version_17/checkpoint/epoch=410-step=43976.ckpt'
